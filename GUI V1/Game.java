...
public class Game extends JFrame{
    ...
    public void gameMethod(){
        ...
        blockArray[0][1]=new newBlock("block", 14);
    ...
    public void paint(Graphics g){
        ...
        for (int j=0; j<blockArray.length; j++){
            for (int i=0; i<blockArray.length; i++){
                ...
                g2.fillRect((PANEL_X_SIZE/2)-30-(BLOCK_SIZE/2) +(i*spacing),(PANEL_X_SIZE/2)-30+(j*spacing), BLOCK_SIZE,BLOCK_SIZE);
            }
            else{
        ...
        g2.setFont(font);
        g2.drawString("Your score is "+score.getScore(),(PANEL_X_SIZE/2)-75,75);
    } 
