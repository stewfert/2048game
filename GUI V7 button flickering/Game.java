...
public class Game extends JPanel implements KeyListener {
    ...
    public void gameMethod(){
        ...
        //adds the keyboard input to my frame.
        this.addKeyListener(this);
        //button that allows the player to start a new game
        JButton newGame = new JButton("New game?");
                setLayout(null);
                this.add(newGame);
                newGame.setBounds(new Rectangle(new Point(200, 300), newGame.getPreferredSize()));
    newGame.setVisible(true);
    newGame.setText("New Game?");
    Color buttonColor= new Color(158, 124, 103);
    ...
    public void paint(Graphics g){
        ...
        g1.setColor(BGColor);
        g1.fillRect(0,0,PANEL_X_SIZE, PANEL_Y_SIZE);
        for (int j=0; j<blockArray.length; j++){
            for (int i=0; i<blockArray.length; i++){
